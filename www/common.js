(self["webpackChunkTripplanner"] = self["webpackChunkTripplanner"] || []).push([["common"],{
...
/***/ 3604:
/*!*******************************************************************!*\
  !*** ./src/app/shared/services/plannerService/planner.service.ts ***!
  \*******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "PlannerService": () => (/* binding */ PlannerService)
/* harmony export */ });
...
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! rxjs/operators */ 4395);
...
let PlannerService = class PlannerService {
    ...
    addPost(post) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__awaiter)(this, void 0, void 0, function* () {
            try {
                return yield this.afStore.collection(`posts`).doc(post.id).set(post);
            }
            catch (error) {
    ...
    bookmarkPost(postId, currentUserId) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__awaiter)(this, void 0, void 0, function* () {
            try {
                const post = (yield this.afStore.doc(`posts/${postId}`).get().toPromise()).data();
                const bookmarks = Object.assign({ [currentUserId]: true }, post.bookmarks);
                return yield this.afStore.doc('posts/' + postId).update({ bookmarks });
            }
            catch (error) {
    ...
    undoBookmarkPost(postId, currentUserId) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__awaiter)(this, void 0, void 0, function* () {
            try {
                const post = (yield this.afStore.doc(`posts/${postId}`).get().toPromise()).data();
                delete post.bookmarks[currentUserId];
                return yield this.afStore.doc('posts/' + postId).update({ bookmarks: post.bookmarks });
            }
            catch (error) {
    ...
    mapPosts(posts$) {
        return posts$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.debounceTime)(300), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.map)(actions => {
            return actions.map(action => {
                return Object.assign({ id: action.payload.doc.id }, action.payload.doc.data());
            });
        }));
    }
};
...
PlannerService = (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__decorate)([
...
/***/ 2771:
/*!*****************************************************************!*\
  !*** ./src/app/shared/services/sharedService/shared.service.ts ***!
  \*****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
